...
// android/key.properties (written by release CI from repository secrets, see
// doc/RELEASING.md) enables release signing. When absent, release builds fall
// back to the debug keys so local `flutter run --release` still works.
